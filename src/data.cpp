...
string Table::print(const Tables &tables, string &si) const
{
    ...
    else
    {
        ...
        si += "Text " + getCppName() + "::getName() const\n";
        si += "{\n";
        si += space + "auto s = ((Text *)&" + next(cols.begin())->getName() + ")[gCurrentLocalizationId];" + "\n";
        si += space + "if (!s.empty())" + "\n";
        ...
        {
            string space = ::space + ::space;
            si += space + "s = ((Text *)&" + next(cols.begin())->getName() + ")[i];" + "\n";
            si += space + "if (!s.empty())" + "\n";
            si += space + ::space + "return s;" + "\n";
        }
        si += space + "}" + "\n";
    ...
    if (isProxy)
    {
        ...
        si += "{\n";
        si += space + "return " + getParentVariableName() + ";\n";
        si += "}\n\n";
    }
    ...
    // constructor() -> allow only to copy data
    //s += space + getCppName() + "();\n\n";
    //si += getCppName() + "::" + getCppName() + "()\n";
    //si += "{\n";
    //si += "}\n\n";
...
string Database::printStorage(string &si)
{
    ...
    //for (auto &table : tables)
    //{
        //s += space + "inline const " + table.second.getArrayType() + "<Ptr<" + table.second.getCppName() + ">> &" + table.second.getVariableArrayName() + "() const" + ";\n";
        //si += "const " + table.second.getArrayType() + "<Ptr<" + table.second.getCppName() + ">> &Storage::" + table.second.getVariableArrayName() + "() const" + "\n";
        //si += "{\n";
        //si += space + "return " + table.second.getVariableArrayName() + ";\n";
        //si += "}\n\n";
        //s += space + "inline " + table.second.getArrayType() + "<Ptr<" + table.second.getCppName() + ">> &" + table.second.getVariableArrayName() + "()" + ";\n";
        //si += "" + table.second.getArrayType() + "<Ptr<" + table.second.getCppName() + ">> &Storage::" + table.second.getVariableArrayName() + "()" + "\n";
        //si += "{\n";
        //si += space + "return " + table.second.getVariableArrayName() + ";\n";
        //si += "}\n\n";
    //}
...
string Database::printQtTreeView(string &si)
{
    ...
    for (auto &table : tables)
    {
        if (treeViewItems.find(table.second.getName()) == treeViewItems.end())
            continue;
